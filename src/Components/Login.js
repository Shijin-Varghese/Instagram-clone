      ...
      >
        <div className="car">
          ...
          >
            <Slider>
              <Slide index={0}>
                <Image src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQaZ9GM2EdcAd57Ctxd0mmYbjdokSUEpP7cb5K8yu1y200F_Xnwcs0i5loRR5Y86mxcPMM&usqp=CAU"></Image>
              </Slide>
              <Slide index={1}>
                <Image src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR5FRqTwPDR5I-6Ze2k1EQT_hH343822Cn7Ag&usqp=CAU"></Image>
              </Slide>
            </Slider>
          </CarouselProvider>
        </div>
